...
const CACHE = 'hh-tenant-v8';
const SHELL = ['./', './index.html', '../css/tokens.css', '../css/promo.css', './css/tenant.css', './js/tenant.js', './manifest.webmanifest',
  '../js/icons.js', '../js/art.js', '../js/motion.js', '../js/promo.js', '../js/nlu.js', '../js/gemini.js', '../assets/logo-mark.svg', '../assets/logo-icon.svg', '../assets/logo-3d.webp'];
